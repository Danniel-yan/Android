...
public class CodeHelp {
     ...
     */
    public static HashMap<String, byte[]> getBestImageAndDelta(FaceIDDataStruct idDataStruct) {
...
////					BitmapUtils.saveBmpToFile(BitmapFactory.decodeByteArray(data,0,data.length),key,null);
//                }
//            }).start();
