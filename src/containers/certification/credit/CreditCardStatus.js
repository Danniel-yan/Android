      ...
      <ScrollView style={{flex: 1}}>
        ...
        <View style={{ backgroundColor: "#fff", padding: 8,}}>
          ...
          <View style={{paddingTop: 10, flexDirection: "row", alignItems: "center", ...border("top")}}>
            <Text>信用卡号码</Text>
            <View style={{flex: 1}}>
              <Input type="number" style={{flex: 1, textAlign: "right", fontSize: fontSize.normal, color: "#666", paddingVertical: 1}} value={this.state.form.credit_card_no} onChangeText={this._onInputChange.bind(this, 'credit_card_no')}></Input>
            </View>
          </View>
        </View>
