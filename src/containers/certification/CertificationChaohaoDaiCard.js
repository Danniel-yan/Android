      ...
      <ScrollView>
        <View style={{backgroundColor: "#F2F2F2"}}>
          ...
          <View style={[{marginTop: 8, paddingHorizontal: 10}, styles.bg, styles.borderBtm]}>
            ...
            <StatusItem statusKey="alipay" style={[styles.itemWrap, styles.borderBtm]} onPress={() => this.props.alipayJump && this.props.alipayJump()} />
          ...
          <View style={[{paddingVertical: 15, flexDirection: "row"}, styles.bg]}>
            <StatusItem statusKey="jd" style={{flex: 1, alignItems: "center", ...border("right")}} onPress={() => this.props.jdJump && this.props.jdJump()} />
