                ...
                <ScrollView style={zoneStyles.container}>
                    ...
                    </TouchableOpacity>
                    {
                        this._renderNavItem(require('assets/zone/setting.png'), "设置", {
                            ...
                            //toKey: "RepaymentResult", title: "还款结果"
                        })
                    }
                ...
                <OverlayModal
                    ...
                    <TouchableWithoutFeedback onPress={() => this.setState({modalVisible: false})}>
                        <View style={{alignItems: "center", justifyContent: "center", flex: 1}}>
                            <View
                                style={{paddingHorizontal: 30, paddingVertical: 25, backgroundColor: "#323334", borderRadius: 6}}>
                                <View style={{}}><Text style={{textAlign: "center", fontSize: 14, color: "#EAEBEB"}}>已复制「钞市」到你的剪切板，</Text></View>
                                <View style={{marginTop: 10}}><Text
                                    style={{textAlign: "center", fontSize: 14, color: "#EAEBEB"}}>请打开微信粘贴关注！</Text></View>
                            </View>
                        </View>
        ...
        AsyncStorage.getItem("userToken").then(token => {
            if (token) {
                ...
                this.props.externalPush && this.props.externalPush({
                    ...
                    componentProps: {
                        loginSuccess: () => {
                            this.props.pboc && this.props.pboc({backRoute: {key: "MajorNavigation"}});
                        }
                    },
                });
            }
        ...
        return this.props.isIOS ? (
            <View>
                {this._renderNavItem(require('assets/zone/gongjijinbaogao.png'), "公积金报告", {
                    toKey: loginUser.info ? "GjjReport" : 'Login',
                    componentProps: {
                        loginSuccess: () => this.props.externalPush({
                            key: 'GjjReport',
                            title: '公积金报告',
                            backRoute: {key: "MajorNavigation"}
                        })
                    },
                    title: loginUser.info ? "公积金报告" : '登录',
                    prePress: () => {
