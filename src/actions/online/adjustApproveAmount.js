...
export function receiveAdjustApproveAmount(amount) {
  //return (dispatch, getState) => {
  ...
  //  dispatch({type: 'receiveOnlineAdjustApproveAmount',tempAmount: amount});
  //}

  return {type: 'receiveOnlineAdjustApproveAmount',tempAmount: amount}
}
