                ...
                <View style={[styles.tabs, this.props.style]}>
                    {
                        tabs.map((tab, index) => {
                            ...
                            return <Tab isActive={this.props.curTab == tab.sceneKey } key={`majorTab${index}`}
                                        onPress={this.props.onMajorTabChange} {...tab}/>;
                        })
                    }
                </View>
        ...
        if (props.sceneKey == 'LoanScene') {
            return (
                <TrackingPoint
                    ...
                    <Image source={{uri: props.isActive ? props.activeIcon : props.icon}}
                           style={props.isActive ? styles.widthActive : styles.widthActive}/>
                </TrackingPoint>
            )
        } else {
            return (
                <TrackingPoint
                    ...
                    <Image source={{uri: props.isActive ? props.activeIcon : props.icon}}
                           style={props.isActive ? styles.width : styles.width}/>
